...
namespace WixToolset.Core.Native
{
    ...
    public sealed class MsiInterop
    {
        ...
        // NameToBit arrays
        // UI elements
        public static readonly string[] CommonControlAttributes = { "Hidden", "Disabled", "Sunken", "Indirect", "Integer", "RightToLeft", "RightAligned", "LeftScroll" };
        public static readonly string[] TextControlAttributes = { "Transparent", "NoPrefix", "NoWrap", "FormatSize", "UserLanguage" };
        public static readonly string[] HyperlinkControlAttributes = { "Transparent" };
        public static readonly string[] EditControlAttributes = { "Multiline", null, null, null,    null, "Password" };
        public static readonly string[] ProgressControlAttributes = { "ProgressBlocks" };
        public static readonly string[] VolumeControlAttributes = { "Removable", "Fixed", "Remote", "CDROM", "RAMDisk", "Floppy", "ShowRollbackCost" };
        public static readonly string[] ListboxControlAttributes = { "Sorted", null, null, null, "UserLanguage" };
        public static readonly string[] ListviewControlAttributes = { "Sorted", null, null, null, "FixedSize", "Icon16", "Icon32" };
        public static readonly string[] ComboboxControlAttributes = { "Sorted", "ComboList", null, null, "UserLanguage" };
        public static readonly string[] RadioControlAttributes = { "Image", "PushLike", "Bitmap", "Icon", "FixedSize", "Icon16", "Icon32", null, "HasBorder" };
        public static readonly string[] ButtonControlAttributes = { "Image", null, "Bitmap", "Icon", "FixedSize", "Icon16", "Icon32", "ElevationShield" };
        public static readonly string[] IconControlAttributes = { "Image", null, null, null, "FixedSize", "Icon16", "Icon32" };
        public static readonly string[] BitmapControlAttributes = { "Image", null, null, null, "FixedSize" };
        public static readonly string[] CheckboxControlAttributes = { null, "PushLike", "Bitmap", "Icon", "FixedSize", "Icon16", "Icon32" };
