...
namespace Bootstrapper
{
    ...
    public:
        ...
        void MsiTransactionInstallTest()
        {
            ...
            ValidateCacheCheckpoint(pPlan, fRollback, dwIndex++, 8);
            ...
            ValidateCacheCheckpoint(pPlan, fRollback, dwIndex++, 8);
            ValidateCacheRollbackPackage(pPlan, fRollback, dwIndex++, L"PackageB", FALSE);
            ValidateCacheCheckpoint(pPlan, fRollback, dwIndex++, 14);
            ValidateCacheRollbackPackage(pPlan, fRollback, dwIndex++, L"PackageC", FALSE);
            ...
            Assert::Equal(34ul, pPlan->cExecuteActions);
            ...
            Assert::Equal(33ul, pPlan->cRollbackActions);
