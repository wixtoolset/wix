# WixToolset.Data - fundamental data types for the WiX Toolset

The `WixToolset.Data` package provides the fundamental data types used throughout the WiX Toolset.
