        ...
        public void CanGetRemoteBundlePayload()
        {
            ...
            using (var fs = new DisposableFileSystem())
            {
                ...
                var ignoreAttributesByElementName = new Dictionary<string, List<string>>
                {
                    ...
                    { "RemoteBundle", new List<string> { "BundleCode", "EngineVersion", "ProviderKey" } },
                ...
                WixAssert.StringEqual(
                    ...
                    "<RemoteBundle BundleCode='*' DisplayName='DiversePayloadsBundle' EngineVersion='*' InstallSize='3790116' ManifestNamespace='http://wixtoolset.org/schemas/v4/2008/Burn' Scope='perMachine' ProviderKey='*' ProtocolVersion='1' Version='1.0.0.0' Win64='no' UpgradeCode='{FEF1D2B8-4737-4A2A-9F91-77F7294FB55B}' />" +
        ...
        public void CanGetRemoteBundlePayloadWithCertificate()
        {
            ...
            using (var fs = new DisposableFileSystem())
            {
                ...
                WixAssert.CompareLineByLine(new string[]
                {
                    ...
                    "<RelatedBundle Code='{65E893AD-EDD5-4E7D-80CA-F0F50F383532}' Action='Upgrade' />" +
        ...
        public void CanGetRemoteV3BundlePayload()
        {
            ...
            using (var fs = new DisposableFileSystem())
            {
                ...
                WixAssert.CompareLineByLine(new[]
                {
                    ...
                    "    <RemoteBundle BundleCode='{215A70DB-AB35-48C7-BE51-D66EAAC87177}' DisplayName='CustomV3Theme' InstallSize='1135' ManifestNamespace='http://schemas.microsoft.com/wix/2008/Burn' Scope='perMachine' ProviderKey='{215a70db-ab35-48c7-be51-d66eaac87177}' ProtocolVersion='1' Version='1.0.0.0' Win64='no' UpgradeCode='{2BF4C01F-C132-4E70-97AB-2BC68C7CCD10}' />",
                    "  </BundlePackagePayload>",
                    "</BundlePackage>",
                }, elements);
            }
