    ...
    public class DependencyExtensionFixture
    {
        ...
        public void CanBuildBundleWithCustomProviderKey()
        {
            ...
            using (var fs = new DisposableFileSystem())
            {
                ...
                {
                    "<Registration BundleId='WixToolsetTest.TestBundle' Code='*' ExecutableName='test.exe' Scope='perMachine' Tag='' Version='1.0.0.0' ProviderKey='MyProviderKey,v1.0' PrimaryUpgradeCode='{DFEA7F84-8F9D-5330-AAAE-7D849E650215}'><Arp DisplayName='BurnBundle' DisplayVersion='1.0.0.0' Publisher='Example Corporation' /></Registration>",
                }, registration);
            }
        }
