    ...
    public class ContainerFixture
    {
        ...
        public void HarvestedPayloadsArePutInCorrectPackage()
        {
            ...
            using (var fs = new DisposableFileSystem())
            {
                ...
                WixAssert.CompareLineByLine(new[]
                {
                    "<MsiPackage Id='FirstX86.msi' Cache='keep' CacheId='*' InstallSize='*' Size='*' Scope='perMachine' Permanent='no' Vital='yes' RollbackBoundaryForward='WixDefaultBoundary' LogPathVariable='WixBundleLog_FirstX86.msi' RollbackLogPathVariable='WixBundleRollbackLog_FirstX86.msi' ProductCode='*' Language='1033' Version='1.0.0.0' UpgradeCode='{C00D7E9A-1276-51ED-B782-A20AB34D4070}'>" +
