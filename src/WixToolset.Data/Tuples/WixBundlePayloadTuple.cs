...
namespace WixToolset.Data.Tuples
{
    ...
    public class WixBundlePayloadTuple : IntermediateTuple
    {
        ...
        {
            get => (string)this.Fields[(int)WixBundlePayloadTupleFields.WixBundlePayload]?.Value;
            set => this.Set((int)WixBundlePayloadTupleFields.WixBundlePayload, value);
        }

        public string Name
        {
            get => (string)this.Fields[(int)WixBundlePayloadTupleFields.Name]?.Value;
            set => this.Set((int)WixBundlePayloadTupleFields.Name, value);
        }

        public string SourceFile
        {
            get => (string)this.Fields[(int)WixBundlePayloadTupleFields.SourceFile]?.Value;
            set => this.Set((int)WixBundlePayloadTupleFields.SourceFile, value);
        }

        public string DownloadUrl
        {
            get => (string)this.Fields[(int)WixBundlePayloadTupleFields.DownloadUrl]?.Value;
