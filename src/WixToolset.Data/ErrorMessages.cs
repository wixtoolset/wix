...
namespace WixToolset.Data
{
    ...
    public static class ErrorMessages
    {
        ...
        public static Message IllegalCompressionLevel(string compressionLevel)
        {
            return Message(null, Ids.IllegalCompressionLevel, "The compression level '{0}' is not valid. Valid values are 'none', 'low', 'medium', 'high', and 'mszip'.", compressionLevel);
        }
