...
/* ****************************************************************
 AddUserHttpCertificate - CUSTOM ACTION ENTRY POINT for adding per-user
                      certificates

 * ***************************************************************/
extern "C" UINT __stdcall AddUserHttpCertificate(
    __in MSIHANDLE hInstall
    )
{
    HRESULT hr = S_OK;
    ...
    hr = WcaInitialize(hInstall, "AddUserHttpCertificate");
    ExitOnFailure(hr, "Failed to initialize AddUserHttpCertificate.");
    ...
    )
{
    ...
    hr = WcaInitialize(hInstall, "AddMachineHttpCertificate");
    ExitOnFailure(hr, "Failed to initialize AddMachineHttpCertificate.");
...
/* ****************************************************************
 DeleteUserHttpCertificate - CUSTOM ACTION ENTRY POINT for deleting 
                         per-user certificates

 * ***************************************************************/
extern "C" UINT __stdcall DeleteUserHttpCertificate(
    __in MSIHANDLE hInstall
    )
{
    HRESULT hr = S_OK;
    ...
    hr = WcaInitialize(hInstall, "DeleteUserHttpCertificate");
    ExitOnFailure(hr, "Failed to initialize DeleteUserHttpCertificate.");
...
/* ****************************************************************
 DeleteMachineHttpCertificate - CUSTOM ACTION ENTRY POINT for deleting
                            per-machine certificates

 * ***************************************************************/
extern "C" UINT __stdcall DeleteMachineHttpCertificate(
    __in MSIHANDLE hInstall
    )
{
    HRESULT hr = S_OK;
    ...
    hr = WcaInitialize(hInstall, "DeleteMachineHttpCertificate");
