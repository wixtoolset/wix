...
#if defined(_M_ARM64)
#define CUSTOM_ACTION_DECORATION6(f) L"Wix6" f L"_A64"
#elif defined(_M_AMD64)
#define CUSTOM_ACTION_DECORATION6(f) L"Wix6" f L"_X64"
#elif defined(_M_ARM)
#define CUSTOM_ACTION_DECORATION6(f) L"Wix6" f L"_ARM"
#else
