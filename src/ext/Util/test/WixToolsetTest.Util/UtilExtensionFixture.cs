...
namespace WixToolsetTest.Util
{
    ...
    public class UtilExtensionFixture
    {
        ...
        public void CanCreateUserGroupWithComment()
        {
            ...
            var results = build.BuildAndQuery(BuildX64, "Binary", "CustomAction", "Wix4Group", "Wix6Group");
            WixAssert.CompareLineByLine(new[]
            {
                "Binary:Wix4UtilCA_X64\t[Binary data]",
                ...
                "Wix4Group:TEST_GROUP03\tComponent1\ttestName03\t",
                "Wix4Group:TEST_GROUP04\tComponent1\ttestName04\t",
                "Wix4Group:TEST_GROUP05\tComponent1\ttestName05\t",
                "Wix4Group:TEST_GROUP06\tComponent1\ttestName06\t",
                "Wix4Group:TEST_GROUP07\tComponent1\ttestName07\t",
                "Wix4Group:TEST_GROUP08\tComponent1\ttestName08\t",
                "Wix4Group:TEST_GROUP09\tComponent1\ttestName09\t",
                "Wix4Group:TEST_GROUP10\tComponent1\ttestName10\t",
                "Wix4Group:TEST_GROUP11\tComponent1\ttestName11\t",
                "Wix4Group:TEST_GROUP12\tComponent1\ttestName12\t",
                "Wix4Group:TEST_GROUP13\tComponent1\ttestName13\t",
                "Wix4Group:TEST_GROUP14\tComponent1\ttestName14\t",
                "Wix4Group:TEST_GROUP15\tComponent1\ttestName15\t",
                "Wix4Group:TEST_GROUP16\tComponent1\ttestName16\t",
                "Wix4Group:TEST_GROUP17\tComponent1\ttestName17\t",
                "Wix4Group:TEST_GROUP18\tComponent1\ttestName18\t",
                "Wix4Group:TEST_GROUP19\tComponent1\ttestName19\t",
                "Wix4Group:TEST_GROUP20\tComponent1\ttestName20\t",
                "Wix4Group:TEST_GROUP21\tComponent1\ttestName21\t",
                "Wix4Group:TEST_GROUP22\tComponent1\ttestName22\t",
                "Wix4Group:TEST_GROUP23\tComponent1\ttestName23\t",
                "Wix4Group:TEST_GROUP24\tComponent1\ttestName24\t",
                "Wix4Group:TEST_GROUP25\tComponent1\ttestName25\t",
                "Wix4Group:TEST_GROUP26\tComponent1\ttestName26\t",
                "Wix4Group:TEST_GROUP27\tComponent1\ttestName27\t",
                "Wix4Group:TEST_GROUP28\tComponent1\ttestName28\t",
                "Wix4Group:TEST_GROUP29\tComponent1\ttestName29\t",
                "Wix4Group:TEST_GROUP30\tComponent1\ttestName30\t",
                "Wix4Group:TEST_GROUP31\tComponent1\ttestName31\t",
                "Wix4Group:TEST_GROUP32\tComponent1\ttestName32\t",
                "Wix4Group:TEST_GROUP33\tComponent1\ttestName33\t",
                "Wix4Group:TEST_GROUP34\tComponent1\ttestName34\t",
                "Wix4Group:TEST_GROUP35\tComponent1\ttestName35\t",
                "Wix4Group:TEST_GROUP36\tComponent1\ttestName36\t",
                "Wix4Group:TEST_GROUP37\tComponent1\ttestName37\t",
                "Wix4Group:TEST_GROUP38\tComponent1\ttestName38\t",
                "Wix4Group:TEST_GROUP39\tComponent1\ttestName39\t",
                "Wix4Group:TEST_GROUP40\tComponent1\ttestName40\t",
                "Wix4Group:TEST_GROUP41\tComponent1\ttestName41\t",
                "Wix4Group:TEST_GROUP42\tComponent1\ttestName42\t",
                "Wix4Group:TEST_GROUP43\tComponent1\ttestName43\t",
                "Wix4Group:TEST_GROUP44\tComponent1\ttestName44\t",
                "Wix4Group:TEST_GROUP45\tComponent1\ttestName45\t",
                "Wix4Group:TEST_GROUP46\tComponent1\ttestName46\t",
                "Wix4Group:TEST_GROUP47\tComponent1\ttestName47\t",
                "Wix4Group:TEST_GROUP48\tComponent1\ttestName48\t",
                "Wix4Group:TEST_GROUP49\tComponent1\ttestName49\t",
                "Wix4Group:TEST_GROUP50\tComponent1\ttestName50\t",
                "Wix4Group:TEST_GROUP51\tComponent1\ttestName51\t",
                "Wix4Group:TEST_GROUP52\tComponent1\ttestName52\t",
                "Wix4Group:TEST_GROUP53\tComponent1\ttestName53\t",
                "Wix4Group:TEST_GROUP54\tComponent1\ttestName54\t",
                "Wix4Group:TEST_GROUP55\tComponent1\ttestName55\t",
                "Wix4Group:TEST_GROUP56\tComponent1\ttestName56\t",
                "Wix4Group:TEST_GROUP57\tComponent1\ttestName57\t",
                "Wix4Group:TEST_GROUP58\tComponent1\ttestName58\t",
                "Wix4Group:TEST_GROUP59\tComponent1\ttestName59\t",
                "Wix4Group:TEST_GROUP60\tComponent1\ttestName60\t",
                "Wix4Group:TEST_GROUP61\tComponent1\ttestName61\t",
                "Wix4Group:TEST_GROUP62\tComponent1\ttestName62\t",
                "Wix4Group:TEST_GROUP63\tComponent1\ttestName63\t",
                "Wix4Group:TEST_GROUP64\tComponent1\ttestName64\ttestDomain00",
                "Wix4Group:TEST_GROUP65\tComponent1\ttestName65\ttestDomain01",
                "Wix4Group:TEST_GROUP66\tComponent1\ttestName66\ttestDomain02",
                "Wix4Group:TEST_GROUP67\tComponent1\ttestName67\ttestDomain03",
                "Wix6Group:TEST_GROUP00\tTest Comment 1\t0",
                "Wix6Group:TEST_GROUP01\tTest Comment 1\t16",
                "Wix6Group:TEST_GROUP02\t\t32",
                "Wix6Group:TEST_GROUP03\t\t48",
                "Wix6Group:TEST_GROUP04\tTest Comment 1\t256",
                "Wix6Group:TEST_GROUP05\tTest Comment 1\t272",
                "Wix6Group:TEST_GROUP06\t\t288",
                "Wix6Group:TEST_GROUP07\t\t304",
                "Wix6Group:TEST_GROUP08\tTest Comment 1\t512",
                "Wix6Group:TEST_GROUP09\tTest Comment 1\t528",
                "Wix6Group:TEST_GROUP10\t\t544",
                "Wix6Group:TEST_GROUP11\t\t560",
                "Wix6Group:TEST_GROUP12\tTest Comment 1\t768",
                "Wix6Group:TEST_GROUP13\tTest Comment 1\t784",
                "Wix6Group:TEST_GROUP14\t\t800",
                "Wix6Group:TEST_GROUP15\t\t816",
                "Wix6Group:TEST_GROUP16\tTest Comment 1\t1024",
                "Wix6Group:TEST_GROUP17\tTest Comment 1\t1040",
                "Wix6Group:TEST_GROUP18\t\t1056",
                "Wix6Group:TEST_GROUP19\t\t1072",
                "Wix6Group:TEST_GROUP20\tTest Comment 1\t1280",
                "Wix6Group:TEST_GROUP21\tTest Comment 1\t1296",
                "Wix6Group:TEST_GROUP22\t\t1312",
                "Wix6Group:TEST_GROUP23\t\t1328",
                "Wix6Group:TEST_GROUP24\tTest Comment 1\t1536",
                "Wix6Group:TEST_GROUP25\tTest Comment 1\t1552",
                "Wix6Group:TEST_GROUP26\t\t1568",
                "Wix6Group:TEST_GROUP27\t\t1584",
                "Wix6Group:TEST_GROUP28\tTest Comment 1\t1792",
                "Wix6Group:TEST_GROUP29\tTest Comment 1\t1808",
                "Wix6Group:TEST_GROUP30\t\t1824",
                "Wix6Group:TEST_GROUP31\t\t1840",
                "Wix6Group:TEST_GROUP32\t\t2048",
                "Wix6Group:TEST_GROUP33\t\t2064",
                "Wix6Group:TEST_GROUP34\t\t2080",
                "Wix6Group:TEST_GROUP35\t\t2096",
                "Wix6Group:TEST_GROUP36\t\t2304",
                "Wix6Group:TEST_GROUP37\t\t2320",
                "Wix6Group:TEST_GROUP38\t\t2336",
                "Wix6Group:TEST_GROUP39\t\t2352",
                "Wix6Group:TEST_GROUP40\t\t2560",
                "Wix6Group:TEST_GROUP41\t\t2576",
                "Wix6Group:TEST_GROUP42\t\t2592",
                "Wix6Group:TEST_GROUP43\t\t2608",
                "Wix6Group:TEST_GROUP44\t\t2816",
                "Wix6Group:TEST_GROUP45\t\t2832",
                "Wix6Group:TEST_GROUP46\t\t2848",
                "Wix6Group:TEST_GROUP47\t\t2864",
                "Wix6Group:TEST_GROUP48\t\t3072",
                "Wix6Group:TEST_GROUP49\t\t3088",
                "Wix6Group:TEST_GROUP50\t\t3104",
                "Wix6Group:TEST_GROUP51\t\t3120",
                "Wix6Group:TEST_GROUP52\t\t3328",
                "Wix6Group:TEST_GROUP53\t\t3344",
                "Wix6Group:TEST_GROUP54\t\t3360",
                "Wix6Group:TEST_GROUP55\t\t3376",
                "Wix6Group:TEST_GROUP56\t\t3584",
                "Wix6Group:TEST_GROUP57\t\t3600",
                "Wix6Group:TEST_GROUP58\t\t3616",
                "Wix6Group:TEST_GROUP59\t\t3632",
                "Wix6Group:TEST_GROUP60\t\t3840",
                "Wix6Group:TEST_GROUP61\t\t3856",
                "Wix6Group:TEST_GROUP62\t\t3872",
                "Wix6Group:TEST_GROUP63\t\t3888",
                "Wix6Group:TEST_GROUP64\tTest Comment 1\t0",
                "Wix6Group:TEST_GROUP65\tTest Comment 1\t16",
                "Wix6Group:TEST_GROUP66\t\t32",
                "Wix6Group:TEST_GROUP67\t\t48",
            }, results.OrderBy(s => s).ToArray());
        }
