    ...
    public static partial class IisSymbolDefinitions
    {
        public static readonly IntermediateSymbolDefinition IIsWebDirProperties = new IntermediateSymbolDefinition(
            ...
            new[]
            {
                ...
                new IntermediateFieldDefinition(nameof(IIsWebDirPropertiesSymbolFields.DirBrowseFlags), IntermediateFieldType.Number),
            },
...
namespace WixToolset.Iis.Symbols
{
    ...
    public class IIsWebDirPropertiesSymbol : IntermediateSymbol
    {
        ...
        {
            get => (int?)this.Fields[(int)IIsWebDirPropertiesSymbolFields.DirBrowseFlags].AsNullableNumber();
            set => this.Set((int)IIsWebDirPropertiesSymbolFields.DirBrowseFlags, value);
        }
    }
}
