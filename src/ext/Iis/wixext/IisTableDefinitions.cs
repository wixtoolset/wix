    ...
    public static class IisTableDefinitions
    {
        ...
        public static readonly TableDefinition IIsWebDirProperties = new TableDefinition(
            ...
            new[]
            {
                ...
                new ColumnDefinition("DirBrowseFlags", ColumnType.Number, 4, primaryKey: false, nullable: true, ColumnCategory.Unknown, description: "Specifies DirBrowseFlags IIS metabase property."),
            },
            symbolIdIsPrimaryKey: true
        );
