# WixToolset.Dtf.Compression.Zip - managed zip compression API

The `WixToolset.Dtf.Compression.Zip` package contains the managed libraries for zip archive packing and unpacking.
