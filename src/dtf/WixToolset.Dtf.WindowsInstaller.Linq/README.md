# WixToolset.Dtf.WindowsInstaller.Linq - managed Widows Installer LINQ extensions

The `WixToolset.Dtf.WindowsInstaller.Linq` package contains the LINQ extensions for the managed Windows Installer API.
