# WixToolset.Dtf.Resources - managed executable resource API

The `WixToolset.Dtf.Resources` package contains support for reading and writing resource data in executable files.
