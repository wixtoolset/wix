# WixToolset.DUtil (dutil.lib) - foundation library for all native code in WiX Toolset

The `WixToolset.DUtil` package provides native code utility functions used throughout the WiX Toolset.
