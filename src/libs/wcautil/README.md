# WixToolset.WcaUtil (wcautil.lib) - WiX Toolset Custom Action native utility library

The `WixToolset.WcaUtil` package provides native code functions to aid the development of Custom Actions.
